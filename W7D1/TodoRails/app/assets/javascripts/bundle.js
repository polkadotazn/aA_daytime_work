...
exports.createTodoThunkAction = exports.fetchTodos = exports.receiveTodo = exports.receiveTodos = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = undefined;
...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    return (0, _todo_api_util.fetchAllTodos)().then(function (serverTodos) {
      return dispatch(receiveTodos(serverTodos));
    });
  };
};

var createTodoThunkAction = exports.createTodoThunkAction = function createTodoThunkAction(todo) {
  return function (dispatch) {
    console.log('todo:' + todo);
    return (0, _todo_api_util.createTodo)(todo).then(function (serverTodo) {
...
var _thunk = __webpack_require__(157);
...
var configureStore = function configureStore() {
  ...
  (0, _redux.applyMiddleware)(_thunk.thunk));
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODOS:
      ...
      action.todos.map(function (todo, idx) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    createTodo: function createTodo(todo) {
      return dispatch((0, _todo_actions.createTodoThunkAction)(todo));
    }
  };
};
...
var TodoListItem = function (_React$Component) {
  ...
  _createClass(TodoListItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "li",
        { className: "list-item-container", key: todo.id },
        todo.title,
  ...
  _createClass(TodoForm, [{
    ...
    value: function linkState(key) {
      ...
      return function (event) {
        _this2.setState(_defineProperty({}, key, event.currentTarget.value));
      };
    }
  }, {
    key: 'submit',
